...
exports.disableUser = exports.banUser = exports.deleteUser = exports.updateUser = exports.getUserById = exports.getAllUsers = void 0;
...
const updateUser = async (req, res) => {
    try {
        ...
        const updatedUser = await User.findByIdAndUpdate(id, { name, email, phone, role, membershipStatus, isConfirmed }, { new: true, runValidators: true }).select('-password -confirmationToken -otpExpiry');
        if (!updatedUser) {
            res.status(404).json({ message: 'User not found' });
            return;
        }
...
const disableUser = async (req, res) => {
    try {
        ...
        const disabledUser = await User.findByIdAndUpdate(id, {
            isConfirmed: false,
