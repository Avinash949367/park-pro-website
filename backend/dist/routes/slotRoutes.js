...
router.post('/payments/create-razorpay-order', passport.authenticate('jwt', { session: false }), slotController.createRazorpayOrder);

// Welcome endpoint
router.get('/welcome', slotController.welcome);
